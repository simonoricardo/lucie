defmodule Lucie.Accounts.User do
  use Lucie, :schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Lucie.Repo)
  ...
  """
  def valid_password?(%Lucie.Accounts.User{hashed_password: hashed_password}, password)
